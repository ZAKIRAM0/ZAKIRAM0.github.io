...
---
<style>
	/* Publications page: scoped typography tweaks (no new colors/fonts) */
	.profile-text .pub-list {
		display: flex;
		flex-direction: column;
		gap: 18px;
	}

	.profile-text .pub-entry {
		text-align: left;
	}

	.profile-text .pub-title {
		margin: 0 0 8px 0;
		font-size: 24px;
		line-height: 1.25;
		font-weight: 900;
	...
	.profile-text .pub-meta strong {
		font-weight: 900;
		color: var(--text);
	}

	.profile-text .pub-meta a {
		color: var(--accent);
		font-weight: 800;
		text-decoration: none;
	}

	.profile-text .pub-meta a:hover {
		text-decoration: underline;
	}

	.profile-text .pub-entry p {
		margin: 0 0 12px 0;
	}

	.profile-text .pub-entry p:last-child {
		margin-bottom: 0;
	}
