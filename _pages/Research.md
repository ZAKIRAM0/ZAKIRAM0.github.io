...
<div class="profile-text">
  ...
  <ul style="font-size: 15px; line-height: 1.4; color: #333; padding-left: 18px; margin: 0;">
    <li><strong>Coronal TDEs / ECLEs:</strong> strange, highly ionized iron lines that may appear when a bright flare shines on nearby gas.</li>
    ...
    <li><strong>TDE–QPE links:</strong> whether a one-time disruption can evolve into recurring, quasi-periodic eruptions.</li>
